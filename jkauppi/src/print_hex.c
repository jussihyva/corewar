...
/*   Updated: 2020/08/05 19:36:40 by jkauppi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			print_ascii_string(ssize_t index, unsigned char *line, ssize_t size)
{
	ssize_t		end_point;
	ssize_t		i;
...
void				print_hex(unsigned char *file_content, ssize_t size)
{
	ssize_t		index;
